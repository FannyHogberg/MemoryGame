...
class ViewController: UIViewController, CAAnimationDelegate{
    ...
    @IBAction func btnClicked(_ sender: UIButton) {
        ...
        playCardSoundEffect(list: cardsInThisLevel, index: sender.tag-1)
...
//                removePairOfCards(arrayOfCards: cardsInThisLevel, indexOfCardInArray: sender.tag-1)
    ...
    func removePairOfCards(){
        ...
        allCardsInBank.setAllCardToBeNotFlipped()
    }
    ...
    //MARK :- OPEN TOILET LID ANIMATION
    func openToiletLid() {
    ...
    //ANIMATE GOLDEN IMAGE AROUND VIEW
